...
public class FXMLAnchorPaneGraficoOrdemServicoMesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Map<Integer, ArrayList> dados = ordemServicoDAO.listarQtdOrdemServicoMes();
